...
describe("MissionFactory", function () {
    ...
    describe("Basic tests", function () {
        ...
        it("Should deploy mission", async function () {
            await factory.createSubscription();
            await vrf.fundSubscription(factory.subscriptionId(), ETH.mul(100));

            await factory.createMission(
                "test codex", //string memory _codex,
                ETH.mul(10), //uint256 _totalRewardAmount,
                ETH.mul(100), //uint256 _totalOperationAmount,
                ETH.mul(200), //uint256 _minTotalCollateralPledge,
